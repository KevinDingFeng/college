                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse navbar-collapse-toolbar pull-md-right p-0" id="met-nav-collapse">
                        <ul class="nav navbar-nav navlist">
                            ...
                            <li class="nav-item dropdown m-l-15">
                                <a target="_self" href="/news_view/list" title="资讯中心" class="nav-link dropdown-toggle active" data-toggle="dropdown" data-hover="dropdown" aria-expanded="false">资讯中心</a>
                            </li>
                            <li class="nav-item dropdown m-l-15">
