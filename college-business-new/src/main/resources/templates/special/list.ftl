    ...
    <div class="admin-content-body">
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <button type="button" class="am-btn am-btn-default" onclick="javascript:window.location.href='/sys_special/form';"><span class="am-icon-plus"></span> 新增</button>
              	<#--
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="/special_view/${em.id}" target="_blank" class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span class="am-icon-archive"></span> 查看</a>
                      <a href="/sys_special/form?id=${em.id}" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
			...
			-->
            <form method="post" class="am-form" action="/sys_special" id="newsPageForm">
