...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/special_view/css/main.css">
                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse navbar-collapse-toolbar pull-md-right p-0" id="met-nav-collapse">
                        <ul class="nav navbar-nav navlist">
                            ...
                            <li class="nav-item dropdown m-l-15">
                                <a target="_self" href="/special_view/list" title="专题模块" class="nav-link dropdown-toggle active" data-toggle="dropdown" data-hover="dropdown" aria-expanded="false">专题模块</a>
                            </li>
                            <li class="nav-item dropdown m-l-15">
